        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPlasarii = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Total = table.Column<decimal>(type: "TEXT", nullable: false),
                    NumarOrdine = table.Column<string>(type: "TEXT", nullable: false),
                    EstePlatita = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
